...
/* @var $modelsYandexTariff backend\models\Country */
?>
...
<div class="country-form">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <?= $form->field($model, 'status')->dropDownList(Country::getStatuses()) ?>
                        ...
                        <?php foreach ($modelsYandexTariff as $i => $modelYandexTariff): ?>
                            <div class="item card mb-3"><!-- widgetBody -->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <?= $form->field($modelYandexTariff, "[{$i}]name_tariff")->dropDownList(CountryYandexTariff::getTariffs()) ?>
                                        </div>
                                    </div><!-- .row -->
                                </div>
                            </div>
